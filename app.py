...
restaurantes = [{'nome':'Bom sabor', 'categoria':'Caseira', 'ativo':False}, 
                {'nome':'Pizza Itália', 'categoria':'Massas', 'ativo':True},
                {'nome':'Brigadeiro Mania', 'categoria':'Doces', 'ativo':False}]
...
def listar_restaurantes():
    '''Essa função é responsável por lista os restaurantes'''
